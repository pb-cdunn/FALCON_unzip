...
def parse_args(argv):
    description = """
scan the pread overlap information to identify the best hit from the preads
...
"""
    ...
    parser.add_argument('--output-fn', default='2-asm-falcon/read_maps/pread_to_contigs',
