...
def parse_args(argv):
    description = """
scan the raw read overlap information to identify the best hit from the reads
...
"""
    ...
    parser.add_argument('--output-fn', default='2-asm-falcon/read_maps/rawread_to_contigs',
