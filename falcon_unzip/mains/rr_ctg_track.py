...
def parse_args(argv):
    description = """
Using a dazzler db (base_dir/0-rawreads/raw_reads.db),
scan the raw read overlap information (base_dir/0-rawreads/m*/raw_reads.*.las)
to identify the best hit from the reads
to the contigs with file generated by `fc_get_read_ctg_map` in `./get_ctg_read_map/read_to_contig_map`
"""
