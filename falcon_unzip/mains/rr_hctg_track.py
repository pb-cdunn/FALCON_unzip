...
Stage 1 writes "*.rr_hctg_track.partial.msgpack".
...
"""
    ...
    parser.add_argument(
        ...
        default="{base_dir}/3-unzip/reads/dump_rawread_ids/rawread_ids", help='rawread_ids file (from a task within fc_get_read_ctg_map.py)')
    parser.add_argument(
        '--output', type=str,
        default="{base_dir}/4-quiver/track_reads", help='Output')
    parser.add_argument(
