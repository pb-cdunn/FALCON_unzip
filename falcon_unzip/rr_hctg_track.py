...
to the contigs with read_to_contig_map generated by `fc_get_read_hctg_map`. Write rawread_ids.',
    ...
    parser.add_argument('--n-core', type=int, default=cpu_count() // 2,  # as each LA4Falcon needs 1 also
    ...
    parser.add_argument('--phased-read-file', type=str, default="./3-unzip/all_phased_reads",
                        help='phased-read-file (from where?)')
    parser.add_argument('--read-to-contig-map', type=str, default="./4-quiver/read_maps/read_to_contig_map",
    ...
    parser.add_argument('--bestn', type=int, default=30, help='keep best n hits')
